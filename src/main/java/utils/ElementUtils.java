...
public class ElementUtils {
	...
	public void clickOnElement(WebElement ele, long durationInSec) {
		WebElement webElement= waitForElement(ele,durationInSec);
		webElement.click();
	}
	
	public void typeTextIntoElement(WebElement ele, String textToBeTyped, long durationInSec) {
		WebElement webElement= waitForElement(ele,durationInSec);
		webElement.click();
		webElement.clear();
	...
	public String getTextOfWebelement(WebElement element,long durationInSeconds) {
		WebElement webElement= waitForVisibilityOfElement(element,durationInSeconds);
