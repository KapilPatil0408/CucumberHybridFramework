...
public class Search {
	...
	public void user_enters_valid_product_into_search_box_field(String validProduct) {
		...
		homePage.enterProduct(validProduct);
	}
	...
	public void user_enters_invalid_product_into_search_box_field(String invalidProduct) {
		homePage= new HomePage(driver);
		homePage.enterProduct(invalidProduct);
	}
	
	@Then("User should get a message about no product matching")
	public void user_should_get_a_message_about_no_product_matching() {
	    Assert.assertTrue(searchResultPage.getNoProdcutText().contains("There is no product that matches the search criteria."));
	}
